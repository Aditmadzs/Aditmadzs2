...
def helpbot():
    ...
    helpMessage1 = " 😈「 Setting Blacklist 」\n • Jangan gunakan「 " + key + " 」di depan\n\n" + \
                  ...
                  "🛡 " + key + "Bot4name:「Nama」\n" + \
                  "🛡 " + key + "Bot5name:「Nama」\n" + \
                  "🛡 " + key + "Bot1up「Kirim fhoto」\n" + \
                  "🛡 " + key + "Bot2up「Kirim fhoto」\n" + \
                  "🛡 " + key + "Bot3up「Kirim fhoto」\n" + \
                  "🛡 " + key + "Bot4up「Kirim fhoto」\n" + \
                  "🛡 " + key + "Bot5up「Kirim fhoto」\n" + \
                  "🛡 " + key + "Gift:「Mid」「Jumlah」\n" + \
                  "🛡 " + key + "Spam:「Mid」「Jumlah」\n" + \
                  "\n↪Ketik [Refresh] Jika sudah menggunakan command diatas."                          
    return helpMessage1
  ...
  #[==Finish===]    
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:                              
                               ...
                               elapsed_time = time.time() - start
                               kq.sendMessage(to,format(str(elapsed_time)))                              
